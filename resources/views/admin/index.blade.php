                    ...
                    <div class="panel-heading">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="metric" style="margin: 0px; !important">
                                    <span class="icon"><i class="fa fa-user-o fa-2x"></i></span>
                                    <p>
                    ...
                    <div id="jssor_1"
                        ...
                        <div data-u="slides"
                            ...
                            @foreach ($image_galery as $gambar)
                                <div>
                                    <a href="/dashboard/tambah_gambar"
                                        class="btn btn-sm btn-outline-secondary navbar-right">Tambah
                                        Gambar</a>
                                    <img data-u="image" src="{{ $gambar->getImage() }}" alt="{{ $gambar->title }}" />
                                    <div u="thumb">{{ $gambar->title }} - {{ $gambar->deskripsi }}</div>
                                </div>
                            @endforeach
                        </div><a data-scale="0" href="https://www.jssor.com" style="display:none;position:absolute;">image
                            gallery</a>
                        <!-- Thumbnail Navigator -->
                        ...
                        <div data-u="arrowright" class="jssora061" style="width:55px;height:55px;top:0px;right:25px;"
