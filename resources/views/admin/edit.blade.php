                    ...
                    <div class="col-md-12">
                        ...
                        <form class="form-horizontal" action="/dashboard/{{ $jamaah->id }}/update_data" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input name="grub" type="text" value="{{ old('grub') ? old('grub') : $jamaah->grub }}"
                                        class="form-control" grub="grub" id="grub" placeholder="Masukan Nama grub">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input name="tanggal_lahir" type="text" value="{{ $jamaah->tanggal_lahir }}"
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-2" for="issued_passpor">Tanggal Keluar Passport
                                    : </label>
                                <div class="col-sm-10">
                                    <input name="issued_passpor" type="text" value="{{ $jamaah->issued_passpor }}"
